...
func NewDownloader(clientTimeOut time.Duration, maxFileSize int64) *Downloader {
	return &Downloader{clientTimeOut: clientTimeOut, maxFileSize: maxFileSize, client: http.Client{}}
}
